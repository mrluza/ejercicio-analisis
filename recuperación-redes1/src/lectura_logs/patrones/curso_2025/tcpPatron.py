...
TOPOLOGIA:
TCP va sobre IP, asi que los nodos del grafo son las IPs de los dos extremos
de la conexion. PatronPadre rellena topo_src / topo_dst con esas IPs.
'''
...
class tcpPatron(PatronPadre):
    ...
    def process_log_data(self, data_string):
        # Captura todos los campos de la capa TCP (+ campos de topologia).
