...
TOPOLOGIA:
HTTP va sobre TCP/IP, asi que los nodos del grafo son las IPs del cliente y
del servidor web. PatronPadre rellena topo_src / topo_dst con esas IPs.
'''
...
class httpPatron(PatronPadre):
    ...
    def process_log_data(self, data_string):
        # Captura todos los campos de la capa HTTP (+ campos de topologia).
